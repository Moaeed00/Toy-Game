...
local UI = ReplicatedStorage:WaitForChild("Assets"):WaitForChild("UI")
local DefaultTemplate = UI:WaitForChild("Default")
...
local function createPrompt(prompt, inputType, gui)
	...
	if promptUI == nil then
		promptUI = DefaultTemplate:Clone()
	end
	...
	local function setupImageLabelTweens(imageLabel)
		local imageTransparencyvalue = imageLabel.ImageTransparency
		...
		table.insert(
			tweensForButtonHoldEnd,
			TweenService:Create(imageLabel, tweenInfoFast, { ImageTransparency = imageTransparencyvalue })
		)
